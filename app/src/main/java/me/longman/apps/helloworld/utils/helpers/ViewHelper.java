 ...
 * <p/>
 * <h3>Common uses:</h3>
 * <code>TextView userName = ViewUtils.{@link #findViewById findViewById}(this, R.id.my_text_view);</code> //<b>no more casting!</b><br />
 * <code>TextView userName = ViewUtils.{@link #findViewById findViewById}(parentView, R.id.my_text_view);</code> //<b>no more casting!</b><br />
 ...
 * <code>ViewUtils.{@link #setText setText}(userName, "new text");</code><br />
 * <code>ViewUtils.{@link #appendText appendText}(userName, "appended");</code><br />
...
public class ViewHelper {
    ...
    public static <T extends View> T findViewById(Activity context, int id) {
        ...
        try {
            ...
            LOGE("PercolateAndroidUtils "+message);
    ...
    public static String getText(TextView view) {
        ...
        if (view != null) {
            ...
            LOGD("PercolateAndroidUtils Null view given to getText().  \"\" will be returned.");
        }
        return text;
    }
    ...
    public static void closeKeyboard(Context context, View field) {
        try {
            ...
            LOGE(ex, "PercolateAndroidUtils Error occurred trying to hide the keyboard.  Exception=");
        }
    }
    ...
    public static void showKeyboard(Context context, View field){
        try {
            ...
            LOGE(ex, "Caffeine Error occurred trying to show the keyboard.");
        }
    }
    ...
    public static Bitmap viewToImage(Context context, WebView viewToBeConverted) {
        ...
        try {
            ...
            LOGE(ex, "PercolateAndroidUtils Could not remove top part of the webview image.");
        }
    ...
    public static void setText(Activity context, int field, String text) {
        ...
        if (view instanceof TextView) {
            ...
            LOGD("PercolateAndroidUtils ViewUtils.setText() given a field that is not a TextView");
        }
    }
     ...
     *
     * @param context The current Context or Activity that this method is called from
     * @param id      R.id.xxxx value for the view to hide"expected userName to throw a ClassCastException" + userName
     */
    public static void hideView(Activity context, int id) {
        if (context != null) {
            ...
            if (view != null) {
                ...
                LOGD("PercolateAndroidUtils View does not exist.  Could not hide it.");
            }
        }
    }
